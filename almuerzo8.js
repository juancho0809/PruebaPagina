...
class Almuerzosocho {
  ...
  const menu1 = new Almuerzosocho('Almuerzo 1', 'Carne, Lentejas, Arroz, Arepa y Limonada',"imagenes/carne.png");
  const menu2 = new Almuerzosocho('Almuerzo 2', 'Pierna pernil, Frijoles, Arroz, Arepa y Jugo de Mora','imagenes/pernil.png');
  const menu3 = new Almuerzosocho('Almuerzo 3', 'Chuleta, Pasta, Ensalada, Papa y Jugo de Mango','imagenes/chuleta.png');
